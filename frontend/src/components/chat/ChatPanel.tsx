    ...
    >
            ...
            <div
              className={`max-w-[80%] px-3 py-2 rounded-2xl text-sm leading-relaxed ${
                msg.role === "user"
                  ...
                  : "bg-white/10 dark:bg-gray-100 text-gray-800 dark:text-gray-800 rounded-bl-sm"
              }`}
            >
              {msg.content}
              {msg.streaming && (
      ...
      <div className="px-3 py-3 border-t border-border flex items-center gap-2 shrink-0">
        <input
          ...
          className="flex-1 bg-white/5 dark:bg-gray-100 border border-white/10 dark:border-gray-300 text-gray-900 dark:text-gray-900 placeholder-gray-400 dark:placeholder-gray-500 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50"
        />
        <button
