  ...
  return (
    <aside className="hidden md:flex flex-col w-56 min-h-screen bg-[#0d0d1a] dark:bg-white dark:border-gray-200 px-4 py-6 border-r border-white/5 sticky top-0 self-start overflow-y-auto">
      ...
      <div className="flex flex-col gap-1 mt-4">
        <Link href="/student/settings" className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-900 hover:bg-white/5 dark:hover:bg-gray-100 transition-colors">
          <span>⚙️</span> Settings
        </Link>
        <Link href="/student/help" className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-900 hover:bg-white/5 dark:hover:bg-gray-100 transition-colors">
          <span>❓</span> Help
        </Link>
      </div>
      ...
      {navItems.map((item) => (
        <Link
          ...
          className={`flex flex-col items-center gap-1 text-xs transition-colors ${
            pathname === item.href ? "text-purple-400" : "text-gray-500 dark:text-gray-400 hover:text-white dark:hover:text-gray-900"
          }`}
        >
    ...
    <header className="flex items-center justify-between px-6 py-4 border-b border-white/5 dark:border-gray-200 bg-[#0f0f1a] dark:bg-white sticky top-0 z-40">
      <div className="relative w-full max-w-xs">
        ...
        <input
          ...
          className="w-full bg-[#1a1a2e] dark:bg-gray-100 text-white dark:text-gray-900 placeholder-gray-500 dark:placeholder-gray-400 rounded-xl pl-9 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
        />
      </div>
      <div className="flex items-center gap-4">
        ...
        <button className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-900 transition-colors">🎓</button>
