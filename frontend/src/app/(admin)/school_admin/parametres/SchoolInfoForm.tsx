...
const inputClass = "bg-white/5 dark:bg-gray-100 border border-white/10 dark:border-gray-300 text-foreground rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500";
  ...
  return (
    <div className="rounded-2xl border border-white/10 dark:border-gray-300 bg-surface shadow-md overflow-hidden">
      <div className="px-6 py-4 border-b border-border bg-white/5">
        <h2 className="text-sm font-semibold text-foreground">Informations de l&apos;école</h2>
      </div>
